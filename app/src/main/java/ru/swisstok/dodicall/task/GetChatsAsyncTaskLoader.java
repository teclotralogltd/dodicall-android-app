...
public class GetChatsAsyncTaskLoader extends ContentResolverAsyncTaskLoader<ArrayList<Chat>> {
    public GetChatsAsyncTaskLoader(Context context) {
        super(context);
    }

    @Nullable
    public ArrayList<Chat> loadInBackground(@NonNull ContentResolver contentResolver) {
        return DataProviderHelper.getChats(contentResolver);
    }
}
