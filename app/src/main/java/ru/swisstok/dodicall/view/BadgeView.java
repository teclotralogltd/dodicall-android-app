...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#e6001e"); //Color.RED;
     ...
     * Constructor -
     *
     * create a new BadgeView instance attached to a target {@link android.support.design.widget.TabLayout}
     * tab at a given index.
     *
     * @param context context for this view.
     * @param target the TabLayout to attach the badge to.
     * @param index the position of the tab within the target.
     */
    public BadgeView(Context context, TabLayout target, int index) {
    ...
    private void applyTo(View target) {
        ...
        if (target instanceof TabLayout) {

            // set target to the relevant tab child container
//            target = ((LinearLayout)((TabLayout) target).getChildAt(0)).getChildAt(targetTabIndex);
            target = ((TabLayout) target).getTabAt(targetTabIndex).getCustomView();
            this.target = target;
